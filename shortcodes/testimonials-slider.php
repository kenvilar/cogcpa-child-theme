        ...
        <div class="splide__arrows">
          <button class="splide__arrow splide__arrow--prev">
            <svg width="7" height="11" viewBox="0 0 7 11" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1.22451 10.7963L6.0089 6.01189C6.28999 5.73081 6.28999 5.27629 6.0089 4.9982L1.22451 0.210812C0.943423 -0.0702708 0.488905 -0.0702708 0.210812 0.210812C-0.0672806 0.491896 -0.0702708 0.946413 0.210812 1.22451L4.48687 5.50056L0.210812 9.77661C-0.0702708 10.0577 -0.0702708 10.5122 0.210812 10.7903C0.491896 11.0684 0.946413 11.0714 1.22451 10.7903V10.7963Z" fill="white"/>
            </svg>
          </button>
      ...
      <div class="testimonials-slider" data-slides-for="testimonials-slider">
          ...
          <div class="testimonial-item">
            ...
            <svg width="19" height="17" viewBox="0 0 19 17" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M3.36362 17C2.3953 17 1.57988 16.568 0.91735 15.704C0.305783 14.7892 0 13.5187 0 11.8924C0 9.1988 0.560603 6.8864 1.68181 4.95516C2.85398 2.97309 4.45934 1.32137 6.49789 0L7.87392 1.75336C6.19211 3.12556 4.91801 4.52317 4.05163 5.94619C3.18524 7.31838 2.75205 9.07175 2.75205 11.2063C2.85398 11.1555 3.05783 11.13 3.36362 11.13C4.12807 11.13 4.81609 11.3587 5.42765 11.8161C6.09018 12.2735 6.42145 12.9851 6.42145 13.9507C6.42145 14.9163 6.11567 15.6786 5.5041 16.2377C4.9435 16.7459 4.23 17 3.36362 17ZM14.1425 17C13.1742 17 12.3587 16.568 11.6962 15.704C11.0846 14.7892 10.7789 13.5187 10.7789 11.8924C10.7789 9.1988 11.3395 6.8864 12.4607 4.95516C13.6328 2.97309 15.2382 1.32137 17.2768 0L18.6528 1.75336C16.971 3.12556 15.6969 4.52317 14.8305 5.94619C13.9641 7.31838 13.5309 9.07175 13.5309 11.2063C13.6328 11.1555 13.8367 11.13 14.1425 11.13C14.9069 11.13 15.5949 11.3587 16.2065 11.8161C16.869 12.2735 17.2003 12.9851 17.2003 13.9507C17.2003 14.9163 16.8945 15.6786 16.283 16.2377C15.7224 16.7459 15.0089 17 14.1425 17Z" fill="#017BB1"/>
            </svg>
            ...
            <div class="flex items-center gap-[16px]">
              ...
              <div class="max-w-[107px] w-full">
                <img src="/wp-content/uploads/highground-trading-group.avif" class="w-full h-full object-cover" alt="logo">
              </div>
            </div>
          </div>
					<?php
