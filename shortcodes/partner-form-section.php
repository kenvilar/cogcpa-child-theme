...
add_shortcode( 'partner_form_section', function () {
  ob_start(); ?>
          ...
          <div
            ...
            <div class="vce-row-content" data-vce-element-content="true">
                                                                    ...
                                                                    <div
                                                                      ...
                                                                      <div class="vce-raw-html-wrapper" id="el-59d5f1d0"
                                                                        ...
                                                                        <svg width="16" height="16" viewBox="0 0 16 16"
                                                                          ...
                                                                          <path
                                                                            d="M4.75107 0.74216C4.51667 0.18136 3.90544 -0.11536 3.32388 0.0419017L3.16069 0.0864096C1.24391 0.608636 -0.393948 2.4661 0.0837616 4.7271C1.18457 9.91969 5.27032 14.0055 10.4628 15.1063C12.7268 15.587 14.5812 13.9462 15.1034 12.0294L15.1479 11.8662C15.3082 11.2816 15.0085 10.6704 14.4507 10.439L11.5636 9.23724C11.0741 9.0325 10.5073 9.17493 10.1691 9.58737L9.02376 10.9879C6.93786 9.95233 5.25846 8.21949 4.29413 6.09201L5.60561 5.02382C6.01804 4.68853 6.1575 4.12179 5.95573 3.62924L4.75107 0.74216Z"
                                                                            fill="#1E3348"></path>
                                                                        </svg>
                                                                      </div>
                                                                    </div>
                                                                    ...
                                                                    <div
                                                                      ...
                                                                      <div class="vce-raw-html-wrapper" id="el-96135133"
                                                                        ...
                                                                        <svg width="16" height="12" viewBox="0 0 16 12"
                                                                             ...
                                                                             xmlns="http://www.w3.org/2000/svg">
                                                                          <path
                                                                            d="M1.42415 0C0.637901 0 0 0.644344 0 1.43854C0 1.89107 0.210655 2.31664 0.56966 2.58936L6.74098 7.2646C7.24833 7.64821 7.9426 7.64821 8.44996 7.2646L14.6213 2.58936C14.9803 2.31664 15.1909 1.89107 15.1909 1.43854C15.1909 0.644344 14.553 0 13.7668 0H1.42415ZM0 3.95597V9.59024C0 10.6482 0.851523 11.5083 1.89887 11.5083H13.2921C14.3394 11.5083 15.1909 10.6482 15.1909 9.59024V3.95597L9.30445 8.41543C8.29271 9.18265 6.89823 9.18265 5.88649 8.41543L0 3.95597Z"
                                                                            fill="#1E3348"></path>
                                                                        </svg>
                                                                      </div>
                                                                    </div>
              ...
              textarea {
              	...
              	border: 1px rgba(30, 51, 72, 0.50) solid !important;
              ...
              [role="checkbox"] input:checked {
                background: #1E3348 !important;
                border-color: #1E3348 !important;
              }
              [role="checkbox"] input:checked::after{
                // transform: rotate(-45deg) scale(1) !important;
              }
              [role="checkbox"] input:focus-visible{
                outline: 1px solid #1E3348 !important;
																				...
																				function hideSelectPlaceholder() {
																					...
																					if (sel) {
																						...
																						sel.addEventListener("change", () => {
																							placeholder.hidden = true; // hides it in the dropdown list
																						});
																					}

																					if (!sel) {
																						setTimeout(hideSelectPlaceholder, 100); // Fallback polling every 100ms
																					}
																				}
